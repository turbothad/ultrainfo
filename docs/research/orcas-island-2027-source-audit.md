...
1. **Mile frame.** The organizer bills 25-mile loops and quotes last-lap
   cutoffs at miles 75/80/90/95/100, while calling the total 100.8; the
   ...
   Constitution 20, Camp Moran 25 per lap), matching the page's own station
   miles (Constitution: 20, 45, 70, 95). The 2026 results sheet's split
   columns used 21/46/71/96 for Constitution — a former frame the page
   supersedes.
...
- **Station passes.** 17: the Start plus Mountain Lake (+5), Cascade Lake
  (+15), Mt Constitution (+20), and Camp Moran (+25) on each of four loops,
...
- The 2026 results-sheet split columns use informal station names
  (Lakeside, Forestside) and the former Constitution miles (21/46/71/96);
  the page's names and miles govern.
