...
crew system; the aid spreadsheet carries the pass table; and the CalTopo
...
1. **run100s is stale three ways.** Its 4/3-4/27 dates, 30-hour cutoff,
   and 10,000-foot climb have no counterpart: the 2027 listing says
...
7. **Medical.** The aid page says official stations are "fully stocked
   ...
   at the thirteen aid station stops, null at the Start, turnarounds,
   and Finish.
...
- **Station passes.** 17: the Start, thirteen aid stops over seven
...
- **Medical.** `true` at the thirteen aid stops (decision 7).
