...
Mile** (Saturday 8:00 AM, 43 certified 2.3094-mile loops plus a final short
loop, 30-hour cutoff); the separate Friday Short Course 100 (85 × 1.17078
...
1. **Two 100-mile races.** run100s' single "Jackpot" row conflates the
   ...
   governs this record.
2. **Loop length.** Pass miles use the USATF-certified 2.3094 miles
   (NV23003MWC); the organizer's drawn CalTopo line measures 2.35. The final
   short loop closes the distance at exactly 100.
...
4. **Elevation.** The certified park loop is flat and the organizer
   publishes no vert figure; the profile is the USGS 3DEP value (1,903 ft)
   at the organizer's start/finish marker, held constant. Gain/loss stay
   null.
5. **Water potability.** The 24/7 station serves food and drink with vegan,
   vegetarian, and gluten-free options; nothing certifies potability.
...
- **Station passes.** 45: the Start, 43 certified-loop crossings of the
  Main Strip Aid Station (miles 2.31 through 99.3), and the short-loop
  Finish at 100.
